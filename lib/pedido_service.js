...
async function verMandadosCliente(params) {
  const { id } = params
...
async function actualizarMandadadoRepartidor(id, repartidor_id) {
  ...
  if (checarMandado.delivery_id === null) {
...
module.exports = { agregarMandado, agregarItem, actualizarMandadadoRepartidor, actualizarMandadoHoraEntrega, mostrarItem, verMandadosCliente }